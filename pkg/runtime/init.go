...
func New(eval expr.Evaluator, gp *pool.GoroutinePool, handlerPool *pool.GoroutinePool,
	...
	s store.Store2, adapterInfo map[string]*handler.BuilderInfo,
...
func startWatch(s store.Store2, adapterInfo map[string]*handler.BuilderInfo,
...
func kindMap(adapterInfo map[string]*handler.BuilderInfo,
...
func startController(s store.Store2, adapterInfo map[string]*handler.BuilderInfo,
