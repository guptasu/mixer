...
protoc mixer/pkg/templates/metric/MetricTemplate.gen.proto mixer/pkg/templates/metric/MetricTemplate.proto -I=. -I=api --go_out=${OUTPARAMS}

## SOME MAGIC TO MAKE COMPILER HAPPY
sed -i \
  -e 's/ValueType_VALUE_TYPE_UNSPECIFIED/VALUE_TYPE_UNSPECIFIED/g' \
  mixer/pkg/templates/metric/MetricTemplate.gen.pb.go;

sed -i \
  -e 's/ValueType_VALUE_TYPE_UNSPECIFIED/VALUE_TYPE_UNSPECIFIED/g' \
  mixer/pkg/templates/metric/MetricTemplate.pb.go;
