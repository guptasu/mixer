...
func newReportManagerImpl() ReportManager {
	return &reportManager{}
}

func (m *reportManager) NewReportExecutor(c *cpb.Combined, createAspect CreateAspectFunc, env adapter.Env, df descriptor.Finder, repo template.Repository) (ReportExecutor, error) {
	...
	if len(c.Constructors) > 0 {
		...
		return nil, fmt.Errorf("NewReportExecutor instantiated with empty constructor list")
	}
	...
	return &reportExecutor{c.Builder.Name, tmpl, ti.ProcessReport, v, ctrs}, nil
}
